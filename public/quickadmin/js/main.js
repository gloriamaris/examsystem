$(document).ready(function () {
    ...
    if (typeof window.route_mass_crud_entries_destroy != 'undefined') {
        $('.datatable').siblings('.actions').html('<a href="' + window.route_mass_crud_entries_destroy + '" class="btn btn-xs btn-danger js-delete-selected" onclick="return confirm(\'Delete this user? This action cannot be undone.\');" style="margin-top:0.755em;margin-left: 20px;">Delete selected</a>');
    }

...
@section('content')
<div class="column">
    <h3 class="title is-3">Edit Examination Details</h3>
    <div class="columns">
        <div class="column is-half">
            {!! Form::open(['method' => 'PUT', 'route' => ['exams.update', $exam->id]]) !!}
            <div class="field">
                    ...
                    <div class="select is-fullwidth">
                        <select name="topic_id">
                            @foreach ($courses as $course)
                                <option value="{{ $course->id }}" {{ $course->id == $exam->topic_id ? "selected" : "" }}>{{ $course->title }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
            ...
            <div class="field">
                ...
                <div class="control has-icons-left has-icons-right">
                    <input class="input {{ $errors->has('name') ? 'is-danger' : '' }}" name="name" type="text" placeholder="Midterm/Finals" value="{{ $exam->name }}" required>
            ...
            <div class="field">
                <div class="control">
                    ...
                    <input type="date" class="input" name="date_start" value="{{ $exam->date_start }}" min="{{ date('Y-m-d') }}" required>
                </div>
            ...
            <div class="field">
                <div class="control">
                    ...
                    <input type="date" class="input" name="date_end" value="{{ $exam->date_end }}" min="{{ date('Y-m-d') }}">
                </div>
